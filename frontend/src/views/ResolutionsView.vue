      ...
      >
        <div class="resolution-content">
          ...
          <div class="resolution-meta">
            <span class="date">Created: {{ formatDate(resolution.created_at) }}</span>
            <span class="status" :class="{ completed: resolution.completed }">
              {{ resolution.completed ? 'Completed' : 'In Progress' }}
            </span>
          </div>
        </div>
        <div class="resolution-actions">
          <button
            ...
            :class="['toggle-btn', { completed: resolution.completed }]"
          >
            {{ resolution.completed ? '↩️ Undo' : '✅ Complete' }}
          </button>
          <button @click="deleteResolution(resolution.id)" class="delete-btn">
            🗑️ Delete
          </button>
        </div>
      </div>
      ...
      <div class="modal" @click.stop>
        ...
        <form @submit.prevent="createResolution">
          ...
          <div class="modal-actions">
            ...
            <button type="submit" :disabled="!newResolution.title.trim()" class="submit-btn">
              Create Resolution
            </button>
          </div>
        </form>
